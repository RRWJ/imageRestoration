...
class SRData(data.Dataset):
    ...
    def _set_filesystem(self, dir_data):
        ...
        # if self.args.data_train == 'DIV2K':
        self.ext = ('.jpg', '.jpg')
        # elif self.args.data_test == 'Set5':
        #     self.ext = ('.png', '.png')
    ...
    def __getitem__(self, idx):
        ...
        # return self.transform(pair_t[0]), self.transform(pair_t[1]), filename
        # return {'LR': pair_t[0], 'HR': pair_t[1], 'LR_path': filename, 'HR_path':filename}
        # return self.transform(self.pair_t[0]), self.transform(self.pair_t[1])
    def __len__(self):
        if self.train:
